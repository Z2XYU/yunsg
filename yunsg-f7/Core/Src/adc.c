...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    GPIO_InitStruct.Pin = ULTRAVIOLET_SENSOR_Pin|RAINFALL_SENSOR_Pin|VIBRATION_SENSOR_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(GPIOC, ULTRAVIOLET_SENSOR_Pin|RAINFALL_SENSOR_Pin|VIBRATION_SENSOR_Pin);
...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc)
{
  if (hadc->Instance == ADC1)
  {
    ...
    // 发送线程标志给采样任务
    osThreadFlagsSet(adcSensorsMeasurementTaskHandle, 0x0001);
  }
}
/* USER CODE END 1 */
