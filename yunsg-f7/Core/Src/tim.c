...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = MOTOR_STEP_1_Pin|MOTOR_STEP_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM9_MspPostInit 0 */
    ...
    PE6     ------> TIM9_CH2
    */
    GPIO_InitStruct.Pin = PTC1_Pin|PTC2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = ETC2_Pin|ETC1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
#define DEBUG_HCSR04 0

void HAL_TIM_IC_CaptureCallback(TIM_HandleTypeDef *htim)
{
  int id=get_selected_id_safe();
  HC_SR04_Sensor_t *sensor = &hc_sr04_sensor[id];
  // 控制操作每次是单次的 直接判断这个id
